...
1. What are the dimensions of the dataset?
    The dimensions are 1458 rows and 123 columns

2. What does each row represent?
    Each row represents an individual data entry or record of an individual country in a particular year
...
Considering the number of data points we have, I would use a histogram as that would be a good illustration of the variability of the data and easier for comparison. I would use the same graph for both pf scores and expression control.
...
I would not be comfortable to using a linear model because if the scores are subjective, then that means the scores we got for expression control and pf_scores are subjective hence they might not be the most accurate data points
...
6. Interpret each of the estimated parameters from (5) in the context of this research question.
  ...
  The values represent an increase. For pf_expression_control, if the expression control is 0, then the mean personal freedom score was 4.28. In addition, if we increase expression control by 1 then the mean freedom score increases by 0.542.
...
I think this value doesn't represent a value that is as good as we would like it to be. 
...
10. Interpret each of the estimated parameters from (10) in the context of this research question.
  ...
  The values represent an increase. For pf_expression_control, if the expression control is 0, then the mean personal freedom score was 4.175. In addition, if we increase expression control by 1 then the mean freedom score increases by 0.568.
...
The results were slightly different but they were more or less the same hence one can say the models were more or less accurate when compared to each other
...
11. Is there any apparent pattern in the residuals plot?
    The points are scattered all over, but they mostly fall within -1 to 1 on the residual scale. 
  What does this indicate about the linearity of the relationship between the two variables?
Since points are dispersed, we can say a relationship exists
